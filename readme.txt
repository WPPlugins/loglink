...
All links are generated via the `SHA-256` hash algorithm, and are both time sensitive and User specific.
...
= 150918 =
* Updated integration with WordPress Thickbox w/ title + height adjustment for link generation
* Checked out compatibility with WordPress 4.3.1
* Updated admin page with link for copying key from password field
...
= 150918 =
* Maintenance release of Loglink. Upgrade immediately.
