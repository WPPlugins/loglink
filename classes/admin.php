	...
	public function page() {
				...
				<table class="form-table">
					...
					<tr>
						...
						<td>
							...
							<p class="description">
								Need this key? <a href="#" id="loglink_copy">Copy to clipboard.</a>
							</p>
						</td>
					</tr>
					<tr>
		...
		<script type="text/javascript">
			(function($) {
				...
				var copyClipboard = function(element) {
					var $temp = $("<input>")
					$("body").append($temp);
				...
				$('#loglink_autogen').click(function(e) {
						$('#gen_hash').val(randomString(40));
						e.preventDefault();
				});

				$('#loglink_copy').click(function(e) {
						copyClipboard($('#gen_hash'));
						e.preventDefault();
				});
			})(jQuery);
		</script>
