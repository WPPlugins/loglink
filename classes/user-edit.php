	...
	public function display($user) {
		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					<a href="#TB_inline?width=650&height=175&inlineId=loglink-lightbox" title="Success!" class="thickbox" id="loglink_generate_link">Click here</a> to generate a signed login link for this User.
				</td>
			</tr>
